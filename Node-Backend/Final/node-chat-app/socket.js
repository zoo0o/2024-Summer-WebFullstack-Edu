...
module.exports =(server)=>{
    ...
    io.on("connection",(socket)=>{
        ...
        socket.on('entry',async(channel, nickName)=>{
         ...
         //socket.emit(); 현재 서버소켓을 호출한(입장한) 사용자에게만 메시지 발송하기
