...
const EntryPlus = () => {
   ...
   //Input 요소 타입 이벤트 핸들러 정의하기
   //화면 내 모든 HTMLInputElement 요소의 onChange 이벤트 핸들러 처리 함수 정의하기
   //참조형 데이터(객체, 배열)의 변경은 반드시 참조형 데이터의 복사본을 생성하고 해당 복사본의 속성을 변경해야한다.
   const handleMemberInputChange = (e:React.ChangeEvent<HTMLInputElement>)=>{
      //...member는 해당 객체의 복사본을 만든다는 의미이고 복사본의 해당 UI요소의 name값을 이용해 객체 속성의 값을 변경한다.
      //member 객체의 실제 복사본 객체를 만들고 복사본 객체의 특정 속성 ["속성명"]을 지정하고 값을 변경한 후 복사본을 setMember()함수의
      //맴베 객체 값을 변경한다.
      console.log("onChange 이벤트가 발생한 UI요소의 name값: ",e.target.name);
      console.log("onChange 이벤트가 발생한 UI요소의 value값: ",e.target.value);
   ...
   const handleTelephoneTypeChange = (
      ...
      //member 복사본의 객체의 telephoneType 속성 값을 변경해서 최종 변경된 복사본 객체를 setMemebr()함수의 인자값으로 전달함
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
      ...
      console.log('백엔드에서 전달할 회원가입 데이터', member)
    }
